...
```{r}
full <- read.table("bigdataperenv_bf2_1000_99logbf2_70miss_allwin_all10K.txt", header=T)
...
windna <- read.table("sresbfall_na_1000_99_70miss_allwind.txt", header = T)
windeu <- read.table("sresbfall_eu_1000_99_70miss_allwind.txt", header = T)
windau <- read.table("sresbfall_au_1000_99_70miss_allwind.txt", header = T)
...
write.table(all_windows,"bfall_windows_1000_99_allwind_par_70miss.txt")
...
write.table(windows,"all_windows_1000_99_allwind_info_70miss.txt")
```
