...
Read in data
```{r}
results_testall <- read.table("bf_all_1000-1000_bf99_allwinds", header=T)
results_testna <- read.table("bfall_na_1000_bf99_allwinds", header=T)
results_testeu <- read.table("bfall_eu_1000_bf99_allwinds", header=T)
results_testau <- read.table("bfall_au_1000_bf99_allwinds", header=T)
```
...
topcan.binom <- function(dat, output){
  ...
  #pdf(paste0("_Graph/", output , ".pdf"), width = 4, height = 4)
 # plot(sdat$num.outlier ~ sdat$num.SNPs,  col = as.numeric(sdat$topcan_q +1), xlab= "Number of SNPs per window", ylab="Number of log(bf) outliers", ylim = c(1,5))
...
```{r}
topcan.binom(results_testall, "sresbfall_all_1000_99_allwind.txt")
topcan.binom(results_testna, "sresbfall_na_1000_99_allwind.txt")
topcan.binom(results_testeu, "sresbfall_eu_1000_99_allwind.txt")
topcan.binom(results_testau, "sresbfall_au_1000_99_allwind.txt")
```
...
```{r}
bf_all <- read.table("sresbfall_all_1000_99_allwind.txt")
bf_na <- read.table("sresbfall_na_1000_99_allwind.txt")
bf_eu <- read.table("sresbfall_eu_1000_99_allwind.txt")
bf_au <- read.table("sresbfall_au_1000_99_allwind.txt")
...
write.table(sres_allna, "sresbfall_glna_1000_99_allwind_crossenvvar.txt")
write.table(sres_alleu, "sresbfall_gleu_1000_99_allwind_crossenvvar.txt")
write.table(sres_allau, "sresbfall_glau_1000_99_allwind_crossenvvar.txt")

write.table(sres_naeu, "sresbfall_naeu_1000_99_allwind_crossenvvar.txt")
write.table(sres_naau, "sresbfall_naau_1000_99_allwind_crossenvvar.txt")
write.table(sres_euau, "sresbfall_euau_1000_99_allwind_crossenvvar.txt")

write.table(sres_allna2, "sresbfall_glna_1000_99_allwind_perenvvar.txt")
write.table(sres_alleu2, "sresbfall_gleu_1000_99_allwind_perenvvar.txt")
write.table(sres_allau2, "sresbfall_glau_1000_99_allwind_perenvvar.txt")

write.table(sres_naeu2, "sresbfall_naeu_1000_99_allwind_perenvvar.txt")
write.table(sres_naau2, "sresbfall_naau_1000_99_allwind_perenvvar.txt")
write.table(sres_euau2, "sresbfall_euau_1000_99_allwind_perenvvar.txt")
```
