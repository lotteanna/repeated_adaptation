...
```{r}
snp_allwindow_na <- read.table("xtxna_1000-1000_top99_allwinds_SNPinfo",header = T)
...
allwind_na <- read.table("sres1000-1000_na99_allwinds", header = T) #all windows
...
# do the same for EU
snp_allwindow_eu <- read.table("xtxeu_1000-1000_top99_allwinds_SNPinfo",header = T)
...
allwind_eu <- read.table("sres1000-1000_eu99_allwinds", header = T) #all outlier windows
...
# do the same for AU
snp_allwindow_au <- read.table("xtxau_1000-1000_top99_allwinds_SNPinfo",header = T)
...
allwind_au <- read.table("sres1000-1000_au99_allwinds", header = T) #all outlier windows
...
```{r}
write.table(zscore_na, "zscore_na")
write.table(zscore_eu, "zscore_eu")
write.table(zscore_au, "zscore_au")
...
write.table(dat,"nullwxtx_1000_99_allwin_all10K.txt")
```
