...
```{r}
snp_allwindow_na <- read.table("bfall_na_1000_bf99_allwinds_SNPinfo",header = T)
...
allwind_na <- read.table("sresbfall_na_1000_99_allwind.txt", header = T) #all windows
allwind_na$windID  <- paste(allwind_na$contig, allwind_na$win.start, allwind_na$win.end, allwind_na$envvar,sep="__")

snp_allwindow_eu <- read.table("bfall_eu_1000_bf99_allwinds_SNPinfo",header = T)
...
allwind_eu <- read.table("sresbfall_eu_1000_99_allwind.txt", header = T) #all outlier windows
allwind_eu$windID  <- paste(allwind_eu$contig, allwind_eu$win.start, allwind_eu$win.end,allwind_eu$envvar, sep="__")

snp_allwindow_au <- read.table("bfall_au_1000_bf99_allwinds_SNPinfo",header = T)
...
allwind_au <- read.table("sresbfall_au_1000_99_allwind.txt", header = T) #all outlier windows
...
write.table(dat,"bigdataperenv_bf2_1000_99logbf2_allwin_all10K.txt")
```
