...
```{r}
full <- read.table("nullwxtx_1000_99_allwin_all10K.txt", header=T)
...
windna <- read.table("sres1000-1000_na99_allwinds", header = T)
windeu <- read.table("sres1000-1000_eu99_allwinds", header = T)
windau <- read.table("sres1000-1000_au99_allwinds", header = T)
...
write.table(all_windows,"xtxall_windows_1000-1000_99_allwinds_par.txt")
