...
Read in data
```{r}
results_all99 <- read.table("xtxall_1000-1000_top99_allwinds")

results_na99 <- read.table("xtxna_1000-1000_top99_allwinds")
results_eu99 <- read.table("xtxeu_1000-1000_top99_allwinds")
results_au99 <- read.table("xtxau_1000-1000_top99_allwinds")
```
...
```{r}
topcan.binom(results_all99, "sres1000-1000_all99_allwinds")

topcan.binom(results_na99, "sres1000-1000_na99_allwinds")
topcan.binom(results_eu99, "sres1000-1000_eu99_allwinds")
topcan.binom(results_au99, "sres1000-1000_au99_allwinds")
```
...
write.table(sres99_naeu, "sres99_naeu_1000_allwinds.txt")
sres99_naau <- inner_join(tc_na99, tc_au99, by="sub1")
write.table(sres99_naau, "sres99_naau_1000_allwinds.txt")
sres99_euau <- inner_join(tc_eu99, tc_au99, by="sub1")
write.table(sres99_euau ,"sres99_euau_1000_allwinds.txt")
```
